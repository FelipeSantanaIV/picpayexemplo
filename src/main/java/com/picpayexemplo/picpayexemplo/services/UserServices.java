...
import com.picpayexemplo.picpayexemplo.repositories.UserRepository;
...
public class UserServices {
    ...
    public void validateTransaction(User sender, BigDecimal amount) throws  Exception{
        if (sender.getUserType() == UserType.MERCHANT) {
            throw new Exception("Usuário do tipo Lojista não está autorizado a realização transação");
        }
