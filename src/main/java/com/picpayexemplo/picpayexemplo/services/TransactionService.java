package com.picpayexemplo.picpayexemplo.services;
...
import com.picpayexemplo.picpayexemplo.repositories.TransactionRepository;
...
public class TransactionService {
    ...
    public Transaction createTransaction(TransactionDTO transaction) throws Exception {
        ...
        this.notificationService.sendNotification(sender, "Transação realziada com sucesso!");
